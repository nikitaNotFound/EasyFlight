...
namespace DataAccessLayer.Repositories.Airplanes
{
    ...
    {
        Task<ItemsPageEntity<AirplaneEntity>> GetAllAsync(int currentPage, int pageLimit);
        ...
        Task<ItemsPageEntity<AirplaneEntity>> SearchAirplanesAsync(AirplaneFilterEntity filter);
